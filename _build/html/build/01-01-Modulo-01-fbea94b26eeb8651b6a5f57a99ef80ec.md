...
La {numref}`Figura %s <01-jerarquia-memoria>` muestra cómo es la jerarquía de memoria para un procesador lanzado al mercado a finales del año 2023. En forma complementaria, la {numref}`Figura %s <01-jerarquia-memoria_sky>` detallalocosto asociado al acceso a las distintas memorias
