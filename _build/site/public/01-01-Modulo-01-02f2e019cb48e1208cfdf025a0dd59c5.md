...
Ejemplo de valores de capacidad y Ancho de Banda (velocidad de transporte de datos) para un procesador Intel Core i5 14600K.
```

La {numref}`Figura %s <01-jerarquia-memoria>` muestra cómo es la jerarquía de memoria para un procesador 
